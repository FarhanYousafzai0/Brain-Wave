...
const HumberBorderGradient = (
  ...
  return (
    ...
    >
      <span className="relative z-10 flex lg:hidden">{children}</span>
      <svg
        className="absolute flex lg:hidden inset-0 w-full h-full"
...
export default HumberBorderGradient
